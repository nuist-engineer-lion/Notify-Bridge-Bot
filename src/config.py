...
EMOJI_MAPPING = config.get("emoji_mapping", {"close": 128, "more": 127, "bye": 100, "say": 123, "confirm": 110, "cancel": 32})
...
# 等待 .say 内容的用户：{user_id: {prompt_msg_id, customer_id, reply_id, group_id, segments}}
